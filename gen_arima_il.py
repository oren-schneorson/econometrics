...
data.loc[:, 'CP_SA_sa_adj'] = data.loc[:, 'CP_SA_sa_adj'] / data.loc[data.index == datetime(1996, 1, 31), 'CP_SA_sa_adj'].values
data.loc[:, 'CP_SA_sa_adj'] = data.loc[:, 'CP_SA_sa_adj'] * data.loc[data.index == datetime(1996, 1, 31), 'CP_SA'].values
